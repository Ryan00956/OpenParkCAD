...
optimization weights.operational_risk active for Phase 5N soft-risk scoring
...
report operational_quality              active as Phase 5N local, route, summary, directionality, narrow two-way, and passing bay geometry/spacing/network-anchored meeting risk report
