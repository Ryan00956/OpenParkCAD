...
def build_input_diagnostics(site: SiteSpec, layout: LayoutResult | None = None) -> dict[str, Any]:
    ...
    if layout and layout.operational_quality:
        ...
        warnings.append(f"operational quality checks are active in {mode} mode for Phase 5F")
...
def _constraint_status(site: SiteSpec, layout: LayoutResult | None) -> list[dict[str, str]]:
    ...
    return [
        ...
        },
        {
            ...
            "note": (
                "Phase 5F reports junction, entrance-throat, stall-route risks, and route-summary threshold risks for turnaround dependence and long route patterns; configured modes can score, gate promotion, or hard-reject risky layouts."
